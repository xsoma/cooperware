...
void ImGui::StyleColorsClassic(ImGuiStyle* dst)
{
	...
	colors[ImGuiCol_Border] = ImVec4(1.00f, 1.00f, 1.00f, 1.00);
	colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
	colors[ImGuiCol_FrameBg] = ImVec4(0.80f, 0.80f, 0.80f, 0.30f);   // Background of checkbox, radio button, plot, slider, text input
	colors[ImGuiCol_FrameBgHovered] = ImVec4(0.90f, 0.80f, 0.80f, 0.40f);
	colors[ImGuiCol_FrameBgActive] = ImVec4(0.90f, 0.65f, 0.65f, 0.45f);
	colors[ImGuiCol_TitleBg] = ImVec4(0.27f, 0.27f, 0.54f, 0.83f);
	colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.3f, 0.3f, 0.3f, 1.f);
	colors[ImGuiCol_TitleBgActive] = ImVec4(0.3f, 0.3f, 0.3f, 1.f);
	colors[ImGuiCol_MenuBarBg] = ImVec4(0.40f, 0.40f, 0.55f, 0.80f);
	colors[ImGuiCol_ScrollbarBg] = ImVec4(0.20f, 0.25f, 0.30f, 0.60f);
	colors[ImGuiCol_ScrollbarGrab] = ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 0.8f);
	colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 1.f);
	colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.80f, 0.50f, 0.50f, 0.40f);
	colors[ImGuiCol_ComboBg] = ImVec4(0.20f, 0.20f, 0.20f, 0.99f);
	colors[ImGuiCol_CheckMark] = ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 1.f);
	colors[ImGuiCol_SliderGrab] = ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 1.f);
	colors[ImGuiCol_SliderGrabActive] = ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 1.f);
	colors[ImGuiCol_Button] = ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 1.f);
	colors[ImGuiCol_ButtonHovered] = ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 1.f);
	colors[ImGuiCol_ButtonActive] = ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 1.f);
	colors[ImGuiCol_Header] = ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 1.f);
	colors[ImGuiCol_HeaderHovered] = ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 1.f);
	colors[ImGuiCol_HeaderActive] = ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 1.f);
	colors[ImGuiCol_Separator] = ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 1.f);
	colors[ImGuiCol_SeparatorHovered] = ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 1.f);
	colors[ImGuiCol_SeparatorActive] = ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 1.f);
...
void ImGui::RenderFrame(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool border, float rounding)
{
	...
	if (border && (window->Flags & ImGuiWindowFlags_ShowBorders))
	{
		...
		window->DrawList->AddRect(p_min, p_max, GetColorU32(ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 1.f)), rounding);
	}
}
	...
	if (first_begin_of_the_frame)
	{
		...
		else
		{
			...
			if (!(flags & ImGuiWindowFlags_AlwaysAutoResize) && window->AutoFitFramesX <= 0 && window->AutoFitFramesY <= 0 && !(flags & ImGuiWindowFlags_NoResize))
			{
				...
				resize_col = GetColorU32 /*not this too*/(held ? ImGuiCol_ResizeGripActive : hovered ? ImGuiCol_ResizeGripHovered : ImGuiCol_ResizeGrip);
				if (hovered || held)
			...
			ImU32 bg_col = GetColorU32(/*this changes your menu back*/ GetWindowBgColorIdxFromFlags(flags));
			...
			if (window->RootWindow == window)
			{
				...
				{
					window->DrawList->AddRectFilled(title_bar_rect.GetTL() - ImVec2(style.WindowPadThickness, 0), title_bar_rect.GetBR() + ImVec2(style.WindowPadThickness, 0), GetColorU32(ImVec4(0.3f, 0.3f, 0.3f, 1.f)));
			...
			if (flags & ImGuiWindowFlags_MenuBar)
			{
				...
				if (flags & ImGuiWindowFlags_ShowBorders)
					window->DrawList->AddLine(menu_bar_rect.GetBL(), menu_bar_rect.GetBR(), GetColorU32( /*not fricking thiss too*/ ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 1.f)));
				window->DrawList->AddRectFilled(menu_bar_rect.GetTL(), menu_bar_rect.GetBR(), GetColorU32(/*not this*/ImGuiCol_MenuBarBg), (flags & ImGuiWindowFlags_NoTitleBar) ? window_rounding : 0.0f, ImGuiCorner_TopLeft | ImGuiCorner_TopRight);
			}
			...
			if (flags & ImGuiWindowFlags_ShowBorders)
			{
				window->DrawList->AddRect(title_bar_rect.GetBL(), window->Pos + window->Size, GetColorU32(ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 1.f)), ((style.WindowPadThickness > 0.f && window->RootWindow == window) ? 0.f : window_rounding));
				if (!(flags & ImGuiWindowFlags_NoTitleBar))
				{
					if (style.WindowPadThickness > 0.f && window->RootWindow == window) {
						...
						window->DrawList->AddRect(window->Pos - ImVec2(style.WindowPadThickness, 0), bottombar.Max, GetColorU32(ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 1.f)), window_rounding);
					}
					else
						window->DrawList->AddLine(title_bar_rect.GetBL() + ImVec2(1, 0), title_bar_rect.GetBR() - ImVec2(1, 0), GetColorU32(ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 1.f)));
				}
			}
		}
...
bool ImGui::SliderBehavior(const ImRect& frame_bb, ImGuiID id, float* v, float v_min, float v_max, float power, int decimal_precision, const char* display_format, ImGuiSliderFlags flags   /*const ImRect& frame_bb, ImGuiID id, float* v, float v_min, float v_max, float power, int decimal_precision, ImGuiSliderFlags flags*/)
{
	ImGuiContext& g = *GImGui;
	ImGuiWindow* window = GetCurrentWindow();
	const ImGuiStyle& style = g.Style;
	...
	if (is_horizontal)
		...
		grab_bb = ImRect(ImVec2(frame_bb.Min.x + grab_padding, grab_pos - grab_sz * 0.5f), ImVec2(frame_bb.Max.x - grab_padding, grab_pos + grab_sz * 0.5f));
	window->DrawList->AddRectFilled(grab_bb.Min, grab_bb.Max, GetColorU32(ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 255))); // Main gradient.
...
bool ImGui::SliderFloat(const char* label, float* v, float v_min, float v_max, const char* display_format, float power)
{
	...
	const bool value_changed = SliderBehavior(frame_bb, id, v, v_min, v_max, power, decimal_precision, display_format);
...
void ImGui::RenderCheckMark2(ImVec2 pos, ImU32 col, float sz)
{
	ImGuiContext& g = *GImGui;
	ImGuiWindow* window = g.CurrentWindow;
...
std::unordered_map <ImGuiID, bool> state = {};
std::unordered_map <ImGuiID, float> size = {};
std::unordered_map <ImGuiID, float> size2 = {};
bool ImGui::Checkbox(const char* label, bool* v)
{
	...
	const ImRect check_bb(window->DC.CursorPos, window->DC.CursorPos + ImVec2(label_size.y + style.FramePadding.y * 2 - 4, label_size.y + style.FramePadding.y * 2 - 4)); // We want a square shape to we use Y twice
	...
	const ImRect text_bb(window->DC.CursorPos + ImVec2(0, style.FramePadding.y - 3), window->DC.CursorPos + ImVec2(0, style.FramePadding.y) + label_size);
	...
	auto clr = GetColorU32((held && hovered) ? ImGuiCol_FrameBgActive : /*hovered ? ImGuiCol_FrameBgHovered :*/ ImGuiCol_FrameBg);

	RenderFrame(check_bb.Min, check_bb.Max, clr, true, style.FrameRounding);

	auto fid = (int)id;

	float check_sz = ImMin(check_bb.GetWidth(), check_bb.GetHeight());
	float pad = ImMax(1.0f, (float)(int)(check_sz / 6.0f));

	//RenderCheckMark(check_bb.Min + ImVec2(pad, pad), GetColorU32(ImGuiCol_CheckMark, 0.99f), check_bb.GetWidth() - pad * 2.0f);

	auto sizediff = check_bb.Max.x - check_bb.Min.x;

	/*auto ololo = check_bb.Max.x - check_bb.Min.x;

	if (pressed && *v == state[fid])
		state[fid] ^= 1;
	...
	if (*v != state[fid])
	{
		...
		if (*v) {
			if (size[fid] < ololo)
				size[fid] += ImMin(ololo, 0.45f);
			else
				state[fid] = *v;
		}
	}*/

	/*if (size[fid] < (ololo - 0.35f))
	{
		auto clrR = ((held && hovered) ? ImVec4(0.2862745098f, 0.2862745098f, 0.2862745098f, 1.f) : ImVec4(0.2f, 0.2f, 0.2f, 1.f));

		window->DrawList->AddRectFilled(check_bb.Min + ImVec2(size[fid], 1), check_bb.Max - ImVec2(0, 1), ColorConvertFloat4ToU32(clrR), style.FrameRounding);
	}*/

	auto changed = *v != state[fid];
	//size[fid]

	if (changed)
	{
		if (*v) {
			if (size[fid] < sizediff)
				size[fid] += ImMin(sizediff - size[fid], 1.f);
			else
				state[fid] = *v;
		}
		else {
	...
	{
		if (*v) {
			if (size2[fid] < sizediff)
				size2[fid] += ImMin(sizediff - size2[fid], 0.6f);
		}
		else
			size2[fid] = 0.f;
	}
	...
	if (*v || changed)
		window->DrawList->AddRectFilled(check_bb.Min + ImVec2(1, 1), check_bb.Max - ImVec2(1, 1), GetColorU32(ImGuiCol_CheckMark), style.FrameRounding);
	if (changed/* && *v*/)
		window->DrawList->AddRectFilled(check_bb.Min + ImVec2(size[fid] * 0.5f, size[fid] * 0.5f), check_bb.Max - ImVec2(size[fid] * 0.5f, size[fid] * 0.5f), GetColorU32(ImGuiCol_WindowBg), style.FrameRounding);

	PushClipRect(check_bb.Min, check_bb.Min + ImVec2(size2[fid], check_bb.GetHeight()), false);
	if (*v)
		RenderCheckMark(check_bb.Min + ImVec2(pad, pad), GetColorU32(ImGuiCol_WindowBg, 0.99f), check_bb.GetWidth() - pad * 2.0f);
	PopClipRect();

	if (hovered)
		window->DrawList->AddRect(check_bb.Min, check_bb.Max, GetColorU32(ImGuiCol_FrameBgHovered), style.FrameRounding);
...
bool ImGui::RadioButton(const char* label, bool active)
{
	...
	if (window->Flags & ImGuiWindowFlags_ShowBorders)
	{
		...
		window->DrawList->AddCircle(center, radius, GetColorU32(ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 1.f)), 16);
	}
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImVec2 popup_size)
{
	...
	RenderFrame(frame_bb.Min, frame_bb.Max, GetColorU32(ImGuiCol_FrameBg), true, style.FrameRounding);
	RenderFrame(ImVec2(frame_bb.Max.x - arrow_size, frame_bb.Min.y), frame_bb.Max, GetColorU32( /*popup_open || hovered ? ImGuiCol_ButtonHovered : ImGuiCol_Button*/ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 255))); // FIXME-ROUNDING
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
	...
	if (hovered || selected)
	{
		const ImU32 col = ImGui::GetColorU32(ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 255));
...
bool ImGui::MenuItem(const char* label, const char* shortcut, bool selected, bool enabled)
{
	...
	if (selected)
		RenderCheckMark(pos + ImVec2(window->MenuColumns.Pos[2] + extra_w + g.FontSize * (0.20f + 0.200f), g.FontSize * 0.134f * 0.5f), GetColorU32(enabled ? ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 255) : ImVec4(Variables.menucolor[0], Variables.menucolor[1], Variables.menucolor[2], 255)), g.FontSize * 0.866f);
